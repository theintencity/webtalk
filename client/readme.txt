This is the original readme file of the sample extension
I used from the mozilla web site. For more information on
this extension, please see the project report.
...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\webtalk on
     Windows, /home/user/dev/webtalk on Linux) in a file named
     webtalk@sample.net and copy that file to
